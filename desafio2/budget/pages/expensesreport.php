...
try {
    ...
    echo "<tr><td colspan='4' style='text-align:right; font-weight:bold;'>Total Salidas:</td><td colspan='2'>" . htmlspecialchars($totalIncome) . "</td></tr>";
    echo "</table>";
} catch (PDOException $e) {
    echo "<p>Error al cargar registros de salidas</p>";
